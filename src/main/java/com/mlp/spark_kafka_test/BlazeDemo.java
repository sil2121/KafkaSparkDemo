...
import com.mlp.conf.ConfigurationManager;
import com.mlp.constant.Constants;
...
public class BlazeDemo {
    public static void main(String[] args) {
        ...
        JavaStreamingContext jssc = new JavaStreamingContext(conf, Durations.seconds(500));
        //checkpoint目录
        ...
        try {
            ...
            })).checkpoint(Durations.seconds(500));
            ...
            JavaPairDStream<String, Integer> result2 = wordsAndOne.reduceByKeyAndWindow((Function2<Integer, Integer, Integer>) (x, y) -> x + y,
                    Durations.seconds(500), Durations.seconds(500));
            result2.print();
